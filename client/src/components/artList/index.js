        ...
        {artworks &&
          artworks.map((artworks) => (
            <div key={artworks._id} className="py-3">
              <h3>
                <Link to={`/art/${artworks._id}`}>{artworks.artTitle}</Link>
              </h3>
              <p className="fs-6">
                <strong>{artworks.createdAt}</strong> by{" "}
                <strong>{artworks.username}</strong>
              </p>
              <div className="py-2">
                <div>
                  Art Status: <strong>{artworks.artStatus}</strong>
                </div>
                <div>
                  Art Start Date: <strong>{artworks.artStartDate}</strong>
                </div>
              </div>
              <div>
                <p className="art-summary">
                  Art Summary: {artworks.artSummary}
                </p>
                <p></p>
                <p className="">
